    ...
    public static partial class Jsm
    {
        public static partial class Expression
        {
            public sealed class Math : IValueExpression
            {
                ...
                public static void EvaluateLet(JsmExpressionEvaluator ev, Type type)
                {
                    IValueExpression value = (IValueExpression) ev.Pop();
                    IVariableExpression variable = (IVariableExpression) ev.Pop();

                    ev.Push(new Let(variable, new Math(variable, value, type)));
                }
                ...
                public static void MulLet(JsmExpressionEvaluator ev) => EvaluateLet(ev, Type.Mul);
                public static void DivLet(JsmExpressionEvaluator ev) => EvaluateLet(ev, Type.Div);
                public static void ModLet(JsmExpressionEvaluator ev) => EvaluateLet(ev, Type.Mod);
                public static void AddLet(JsmExpressionEvaluator ev) => EvaluateLet(ev, Type.Add);
                public static void SubLet(JsmExpressionEvaluator ev) => EvaluateLet(ev, Type.Sub);
                ...
                public static void BitAndLet(JsmExpressionEvaluator ev) => EvaluateLet(ev, Type.BitAnd);
                public static void BitXorLet(JsmExpressionEvaluator ev) => EvaluateLet(ev, Type.BitXor);
                public static void BitOrLet(JsmExpressionEvaluator ev) => EvaluateLet(ev, Type.BitOr);
                public static void BitLeftLet (JsmExpressionEvaluator ev) => EvaluateLet(ev, Type.BitLeft);
                public static void BitRightLet(JsmExpressionEvaluator ev) => EvaluateLet(ev, Type.BitRight);
